/* cspell:disable */
/**
 * @file app/admin/messages.tsx
 * @description Master Messages Inbox Registry.
 */
    ...
    return (
      ...
      >
        ...
        <View style={styles.actionRow}>
          <TouchableOpacity
            onPress={() => handleReply(item.sender_email)}
          ...
          <View style={styles.rightActions}>
            ...
            >
              {item.is_read ? (
                ...
                <Circle size={18} color={COLORS.textDim} />
              )}
            </TouchableOpacity>
            <TouchableOpacity
      ...
      <View style={styles.headerContainer}>
        <View>
          ...
          <Text style={styles.subHeader}>
            {messages.filter((m) => !m.is_read).length} new messages
          </Text>
        </View>
